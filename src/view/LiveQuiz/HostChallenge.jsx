          ...
          <div className="row">
            <div className="col-12 col-sm-12 col-md-6 col-lg-6 text-center">
              <div className="arround-border lqhomecrd">
                ...
                <div className="row">
                  <div className="col-12 col-md-12 col-lg-12">
                    <div className="two-group">
                      <img src="" loading="lazy" alt="icon image" />
                      <p>
                ...
                <a href="https://damsdelhi.com/host_challenge">
                  Host A Challenge
                </a>
              </div>
            </div>
              ...
              <div className="arround-border lqhomecrd">
                ...
                <div className="row">
                  <div className="col-12 col-md-12 col-lg-12">
                    <div className="two-group">
                      <img
                        src={`${window.IMG_BASE_URL}/dams-icon/live-quiz-people.png`}
                        loading="lazy"
                        alt="icon image"
                      />
                      <p>
                ...
                <a href="https://damsdelhi.com/live_quiz_playchallenge">
                  Play Challenge
                </a>
              </div>
            </div>
          ...
          <div className="row">
            <div className="col-12 col-sm-12 col-md-6 col-lg-6 text-center">
              <div className="arround-border lqhomelist">
                ...
                <a href="https://damsdelhi.com/accept_challenge">
                  Accept Challenge
                </a>
              </div>
            </div>
            <div className="col-12 col-sm-12 col-md-6 col-lg-6 text-center">
              <div className="arround-border lqhomelist">
                ...
                <a href="https://damsdelhi.com/my_attempted">My Attempts</a>
              </div>
            </div>
          </div>
          <div className="row">
              ...
              <div className="arround-border lqhomecrd">
                <div className="credit-scrach">
                  <div className="mycredit">
                    <img
                      src={`${window.IMG_BASE_URL}/dams-icon/live-quiz-hand.png`}
                      loading="lazy"
                      alt="icon image"
                    />
                    <p>My Credits</p>
            ...
            <div className="col-12 col-sm-12 col-md-6 col-lg-6 text-center">
              <div className="arround-border lqhomecrd">
                <div className="credit-scrach">
                  <div className="mycredit">
                    <img
                      src={`${window.IMG_BASE_URL}/dams-icon/live-scratch.png`}
                      loading="lazy"
                      alt="icon image"
                    />
                    <p>My Scratch Card</p>
