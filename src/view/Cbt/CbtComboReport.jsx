...
const CbtComboReport = () => {
  ...
  const getresultreport = async () => {
    try {
      ...
      const res = await axiosInstance.post(
        API_ENDPOINTS.CBT.CBT_TEST_WIZE_REPORT,
  ...
  const get_cbt_leader_board = async (test_id, testType) => {
    try {
      const res = await axiosInstance.post(
        API_ENDPOINTS.CBT.GET_CBT_LEADER_BOARD,
        {
          test_id: test_id,
  ...
  const get_topic_report = async () => {
    try {
      const res = await axiosInstance.post(API_ENDPOINTS.CBT.GET_TOPIC_REPORT, {
        user_id: user_id,
        test_id: test_id,
      });
    } catch (error) {}
  ...
  const get_cbt_subject_wise_report = async () => {
    try {
      const res = await axiosInstance.post(
        API_ENDPOINTS.CBT.CBT_SUBJECT_WIZE_REPORT,
        { test_id: test_id, user_id: user_id }
      );
  ...
  const get_cbt_question_wise_report = async () => {
    try {
      const res = await axiosInstance.post(
        API_ENDPOINTS.CBT.CBT_QUESTION_WIZE_REPORT,
        { test_id: test_id, user_id: user_id }
      );
  ...
  const get_subject_report = async (subject_id, student_id) => {
    try {
      const res_subject_report = await axiosInstance.post(
        API_ENDPOINTS.CBT.GET_SUBJECT_REPORT,
