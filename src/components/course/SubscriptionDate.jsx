       ...
       >
         <div className="modal-dialog">
           <div className="modal-content">
             <input
               type="hidden"
               name="allow_course_date_select"
               id="allow_course_date_select968"
               value="1"
             />
                   ...
                   <div className="row">
                     <div className="col-12 col-sm-6 col-md-6 col-lg-6 col-xl-6 mobile-pd">
                       <div className="select-imgbg">
                         {" "}
                         <img
                           src={`${window.IMG_BASE_URL}/dams-icon/selectd-img.sv`}
                           loading="lazy"
                           alt="icon image"
                         />
                       </div>
                       ...
                       <div className="row">
                         ...
                         >
                           ...
                           <div className="pro-text">
                             <h3>
                               Validity as per your chosen subscription and
                               start date.
                             </h3>
                             <a
                               href="#"
